        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <i class="bi bi-pencil me-2"></i>Form Edit Karyawan
                </div>
                <div class="card-body">
                    <form action="{{ route('karyawan.update', $karyawan->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('unit_kerja') is-invalid @enderror" id="unit_kerja"
                                ...
                                <option value="Teknis/Marketing/Keuangan/Umum" {{ old('unit_kerja', $karyawan->unit_kerja) == 'Teknis/Marketing/Keuangan/Umum' ? 'selected' : '' }}>
                                    Teknis/Marketing/Keuangan/Umum
                                </option>
                                <option value="Dir/Man/Ass.Man/Staff/Supp.Staff" {{ old('unit_kerja', $karyawan->unit_kerja) == 'Dir/Man/Ass.Man/Staff/Supp.Staff' ? 'selected' : '' }}>
